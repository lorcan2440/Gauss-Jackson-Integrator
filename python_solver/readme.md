...
Example 1. Solve the IVP system $x'' = 2x + 3y' + t$,     &nbsp $y'' = 1 - \sin x'$,     &nbsp $x(0)=1,y(0)=4,x'(0)=2,y'(0)=-1$.
...
$\ddot{\mathbf{r}} = -\frac{GM}{|\mathbf{r}|^2} \mathbf{\hat{r}}$,     &nbsp $\mathbf{r}(0) = [7000,0,0]$,     &nbsp $\dot{\mathbf{r}}(0) = [0, \sqrt{GM / 7000}, 0]$
